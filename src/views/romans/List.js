...
const List = ({ processes, pageNum = 1, totalPages = 0, onClickPage = () => {} }) =>
<div>
<ul class="list-group">
{
      ...
      <div class="row align-items-center gx-2">
        ...
        <div class="col">
          ...
          <ul class="list-inline list-separator small">
            ...
            <li class="list-inline-item">{ new Date(process.createdAt).getDate() + "." + (new Date(process.createdAt).getMonth() + 1) + "." + new Date(process.createdAt).getFullYear() }</li>
